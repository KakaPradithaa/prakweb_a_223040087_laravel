<nav class="bg-gray-800" x-data="{ isOpen: false }">
          ...
          <div class="hidden md:block">
              <div class="ml-4 flex items-center md:ml-6">
                  <div class="relative ml-3">
                      ...
                      <div x-show="isOpen" @click.away="isOpen = false" class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
  ...
  <div x-show="isOpen" class="md:hidden">
      ...
      <div class="border-t border-gray-700 pb-3 pt-4 flex flex-col items-start px-5 space-y-1">
          <div class="flex items-center">
